...
public class ProductServiceTests {
    ...
    public void get_all_product_test(){
        ...
        Mockito.when(productRepository.findAllFetched()).thenReturn(products);
        ...
        Mockito.verify(productRepository, Mockito.times(1)).findAllFetched();
    ...
    public void get_one_by_id_test(){
        // Data preparation
        Mockito.when(productRepository.findByIdFetched(PRODUCT_ID)).thenReturn(java.util.Optional.of(product));
        ...
        Mockito.verify(productRepository, Mockito.times(1)).findByIdFetched(Mockito.anyLong());
        Mockito.verifyNoMoreInteractions(productRepository);
    }
    ...
    public void get_all_product_by_category_test(){
        ...
        //Verification
        assertEquals(products.get(0).getCategoryEntity().getName(), PRODUCT_CATEGORY);
