        ...
        <div className="mx-auto w-full max-w-[560px]">
          ...
          <div className="mb-12 flex flex-col items-center justify-center gap-5 animate-in fade-in slide-in-from-top-8 duration-1000">
            ...
            <div className="text-center">
              ...
              <span className="text-base font-extrabold uppercase tracking-[0.4em] text-blue-600 mt-2 block">Tạo tài khoản</span>
            </div>
          </div>
          ...
          <div className="relative rounded-[3rem] bg-white/70 backdrop-blur-3xl border border-white p-10 sm:p-14 shadow-[0_20px_60px_-15px_rgba(0,0,0,0.1)] animate-in zoom-in-95 duration-700">
            <div className="mb-10 text-center">
              <h1 className="mb-3 font-headline text-4xl font-extrabold tracking-tight text-slate-900">Mở khoá kỷ nguyên mới</h1>
              <p className="text-lg text-slate-600 font-medium leading-relaxed">
                Tài khoản mới sẽ có quyền <code className="rounded bg-slate-200 text-slate-800 px-1.5 py-0.5">ROLE_USER</code>. Vui lòng dùng tên đăng nhập không dấu và email hợp lệ (Gmail) để kích hoạt.
              </p>
            </div>
            ...
            <div className="mt-8 flex flex-col gap-4 animate-in fade-in duration-700 delay-300 fill-mode-both">
              <Link
                href="/login"
                className="inline-flex items-center justify-center gap-2 rounded-2xl bg-white border border-slate-200 w-full py-4 text-base font-bold text-slate-700 transition-all hover:bg-slate-50 hover:text-blue-700 hover:border-blue-300 hover:shadow-md"
              >
