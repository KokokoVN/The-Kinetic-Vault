        ...
        <div className="mx-auto w-full max-w-[560px]">
          <div className="mb-12 flex flex-col items-center justify-center gap-5 animate-in fade-in slide-in-from-top-8 duration-1000">
            ...
            <div className="text-center">
              ...
              <span className="text-base font-extrabold uppercase tracking-[0.4em] text-indigo-600 mt-2 block">Xác thực 2 bước (2FA)</span>
            </div>
          </div>
          ...
          <div className="relative rounded-[3rem] bg-white/70 backdrop-blur-3xl border border-white p-10 sm:p-12 shadow-[0_20px_60px_-15px_rgba(0,0,0,0.1)] animate-in zoom-in-95 duration-700">
            <div className="mb-10 text-center">
              <h1 className="mb-3 font-headline text-3xl font-extrabold tracking-tight text-slate-900">Bảo mật tài khoản</h1>
              <p className="text-base text-slate-600 font-medium">Vui lòng nhập mã từ ứng dụng xác thực hoặc chọn gửi OTP qua Email.</p>
            </div>
            ...
            <div className="mt-8 flex flex-col gap-4">
              <Link
                ...
                className="rounded-[1.25rem] border-2 border-slate-200 bg-white py-4 text-center text-base font-extrabold text-slate-700 transition-all hover:bg-slate-50 hover:border-slate-300"
              >
                Quay lại đăng nhập
              </Link>
            </div>
